  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "C#", icon: <FaUnity className="w-4 h-4 text-[#239120]" /> },
        { name: "C++", icon: <Code2 className="w-4 h-4 text-[#00599C]" /> },
        { name: "JavaScript", icon: <Code2 className="w-4 h-4 text-[#F7DF1E]" /> },
      ],
    },
    {
      icon: Cpu,
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Streamlit", icon: <SiStreamlit className="w-4 h-4 text-[#FF4B4B]" /> },
      ],
    },
    {
      icon: Cloud,
      ...
      skills: [
        ...
        { name: "Firebase", icon: <SiVercel className="w-4 h-4 text-white" /> },
      ],
    },
    {
      icon: Database,
